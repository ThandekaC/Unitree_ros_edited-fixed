...
public:
    ...
    {
        lowState.footForceEst[0] = msg.wrench.force.x;
        lowState.footForceEst[0] = msg.wrench.force.y;
        lowState.footForceEst[0] = msg.wrench.force.z;
        lowState.footForce[0] = msg.wrench.force.z;
    }

    void FLfootCallback(const geometry_msgs::WrenchStamped& msg)
    {
        lowState.footForceEst[1] = msg.wrench.force.x;
        lowState.footForceEst[1] = msg.wrench.force.y;
        lowState.footForceEst[1] = msg.wrench.force.z;
        lowState.footForce[1] = msg.wrench.force.z;
    }

    void RRfootCallback(const geometry_msgs::WrenchStamped& msg)
    {
        lowState.footForceEst[2] = msg.wrench.force.x;
        lowState.footForceEst[2] = msg.wrench.force.y;
        lowState.footForceEst[2] = msg.wrench.force.z;
        lowState.footForce[2] = msg.wrench.force.z;
    }

    void RLfootCallback(const geometry_msgs::WrenchStamped& msg)
    {
        lowState.footForceEst[3] = msg.wrench.force.x;
        lowState.footForceEst[3] = msg.wrench.force.y;
        lowState.footForceEst[3] = msg.wrench.force.z;
